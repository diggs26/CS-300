...
HashTable::~HashTable()
{
    ...
    {
        Node *node = nodes[i].next; // start with first node in chain
        while (node != nullptr)
        {
            Node *temp = node;
            node = node->next;
...
void HashTable::Insert(Bid bid)
{
    ...
    else
    {
        ...
        // assign the node to end of vector
...
void HashTable::PrintAll()
{
    ...
    for (auto &node : nodes)
    {
        ...
        if (node.key != UINT_MAX)
        {
            ...
            cout << "Key: " << node.key << ", Bid ID: " << node.bid.bidId << ", Title: " << node.bid.title << ", Amount: " << node.bid.amount << ", Fund: " << node.bid.fund << endl;
            ...
            {
                // output key, bidID, title, amount and fund
                cout << "[Chain] Bid ID: " << nextNode->bid.bidId << ", Title: " << node.bid.title << ", Amount: " << node.bid.amount << ", Fund: " << node.bid.fund << endl;
...
void HashTable::Remove(string bidId)
{
    ...
    unsigned int hashValue = hash(stoi(bidId));
